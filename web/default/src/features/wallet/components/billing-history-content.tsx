...
/**
 * Reusable billing history content (search, list, pagination, admin
 * complete-order action). Used both inside the billing history dialog and
 * the standalone billing page.
 */
